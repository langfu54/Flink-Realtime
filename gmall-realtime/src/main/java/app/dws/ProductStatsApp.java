...
//7.1 关联SKU维度
        ...
        //TODO 7。 写入CLICKHOUSE
        productStatsWithTmDS.addSink(ClickHouseUtil.clickhouseSink("insert into table product_stats_210325 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
